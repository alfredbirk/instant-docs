  ...
  private constructor(
    ...
    this._panel = vscode.window.createWebviewPanel(
      ...
      column,
      {
        ...
        localResourceRoots: [
          vscode.Uri.joinPath(this._context.extensionUri, "build"),
        ],
      }
    );
    ...
    let recentlyUsedDocs = JSON.parse(
      context.globalState.get("recentlyUsedDocs") || "[]"
    );
    this._panel.webview.postMessage({
      command: "recentlyUsedDocs",
      recentlyUsedDocs,
    });
        ...
        switch (message.command) {
          ...
          case "openDocs":
            ...
            context.globalState.update(
              "recentlyUsedDocs",
              JSON.stringify(recentlyUsedDocs)
            );
