            ...
            switch (message.data.command) {
                case "recentlyUsedDocs":
                    ...
                    const sortedLibraries = librariesFromFile.sort((a, b) => {
                        const aIndex =
                            recentlyUsedDocs.indexOf(a.indexName) === -1 ? 1000 : recentlyUsedDocs.indexOf(a.indexName);
                        const bIndex =
                            recentlyUsedDocs.indexOf(b.indexName) === -1 ? 1000 : recentlyUsedDocs.indexOf(b.indexName);
